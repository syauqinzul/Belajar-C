...
Masukkan nilai mahasiswa 2: 70
Masukkan nilai mahasiswa 3: 90
Masukkan nilai mahasiswa 4: 55
Masukkan nilai mahasiswa 5: 60
=== HASIL STATISTIK NILAI ===
Jumlah mahasiswa    : 5
Total nilai         : 360
Rata-rata           : 72.00
...
Persentase kelulusan: 80.00%
Urutan nilai (terbesar ke terkecil):
90 85 70 60 55 
*/  

// Penjelasan tambahan:
// - Program ini menghitung statistik nilai mahasiswa termasuk total, rata-rata, nilai tertinggi dan
//   terendah, jumlah yang lulus, dan persentase kelulusan.
// - Nilai diurutkan dari yang terbesar ke terkecil menggunakan metode Bubble Sort.
// - Validasi input memastikan nilai yang dimasukkan berada dalam rentang 0-100.
// - Contoh output disediakan untuk ilustrasi hasil program.
